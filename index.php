...
<body>
	<form name="formularioiniciar">
		<p class="LetrasAnimation">Work Go</p>
		<div class="section">
			<div class="container">
									...
									<div class="card-front">
										<div class="center-wrap">
											<div class="section text-center">
												...
												<a><p class="link">¿Olvidaste tu clave de acceso?</a></p>
											</div>
										</div>
									</div>
									<div class="card-back">
	...
	<div class="form-group mt-2">
		<input required type="password" name="RContra" id="Rcontra" class="form-style" placeholder="Clave de acceso">
		<i class="input-icon uil uil-lock-alt"></i>
	</div>

	<div class="form-group mt-2">
		<input required type="password" name="CContra" id="Ccontra" class="form-style" placeholder="Confirmar Clave">
		<i class="input-icon uil uil-lock-alt"></i>
	</div>


	<input name="btnregistrar" class="btn mt-4" value="Crear Cuenta" type="submit" onclick="return validarContraseñas();" >
